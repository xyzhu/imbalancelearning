...
public class SampleEvaluation extends MyEvaluation{

	public SampleEvaluation(Instances data) throws Exception {
		super(data);
	}
	...
	public void crossValidateModel(Classifier classifier, String samplemethod, 
		...
		for (int i = 0; i < numFolds; i++) {
			...
			if(samplemethod.equals("oversample")){
				...
				spreadsubsample.setDistributionSpread(1);//set the ratio of the major class sample to the minor clas
